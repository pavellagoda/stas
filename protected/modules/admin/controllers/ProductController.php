...
//            $model->delete();
    ...
    private function saveModel($model)
    {
        if (isset($_POST['Product'])) {
            ...
            $_POST['Product']['image_extension'] = $model->image_extension;
            ...
            if ($model->save()) {
                ...
                if ($is_image) {
                    ...
                    $file_name_old = Yii::app()->params['PRODUCT_IMAGE_FOLDER'] . '/' . $model->id . '.' . $old_extension;
                    
                    if (is_file($file_name_old)) {
                        unlink($file_name_old);
                    }
                    
                    $file_name = Yii::app()->params['PRODUCT_IMAGE_FOLDER'] . '/' . $model->id . '.' . $extention;
                    move_uploaded_file($_FILES['Product']['tmp_name']['image_extension'], $file_name);
                }
