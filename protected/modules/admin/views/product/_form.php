<div class="form">
    ...
    <div class="categories-block row">
        ...
        echo CHtml::checkBoxList(
                get_class($model) . '[firms]', CHtml::listData(ProductFirm::model()->findAllByAttributes(array('product_id' => $model->id)), 'firm_id', 'firm_id'), CHtml::listData(Firm::model()->findAll(), 'id', 'name'), array(
            'separator' => '',
